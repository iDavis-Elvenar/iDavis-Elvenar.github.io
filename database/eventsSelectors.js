var allEvents = {
    "all_buildings" : { //NAME,ID,SELECTED,DISABLED == HIDDEN
        "2023" : [
            ["A Gateway into the Past","merge_dwarvengame_xxiii_",false,true],
...
var allFas = { //NAME,ID,SELECTED,DISABLED == HIDDEN
    "2023" : [
        ["Fellowship Adventures - August 2023", "august_xxiii_",true,false],
...
var allSeasons = { //NAME,ID,SELECTED,DISABLED == HIDDEN
    "2023" : [
        ["Season of Secrets", "october_xxiii_",false,true],
        ["Season of Triumph", "july_xxiii_",true,false],
