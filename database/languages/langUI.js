...
let ui = {
    ...
    "ru" : {
        ...
        "Prepare": "Подготовка",
        "More": "Более",
        "Culture per square": "Культура на поле",
        "Population per square": "Запасы на поле",
        "Money per square per 1h": "Деньги на поле за 1 час",
        "Supplies per square per 1h": "Припасов на поле за 1 час",
        "Orcs per square per 1h": "Орков на поле за 1 час",
        "Mana per square per 1h": "Мана на поле за 1 час",
        "Seeds per square per 1h": "Семена на поле за 1 час",
